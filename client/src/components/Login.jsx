...
const Login = () => {
  ...
  return (
    <div onClick={()=> setShowUserLogin(false)} className='fixed top-0 bottom-0 left-0 right-0 z-30 flex items-center text-sm text-gray-600 bg-black/10'>
...
items-start p-8 py-12 w-80 sm:w-[352px] rounded-lg shadow-xl border border-gray-200 bg-white">
            ...
            {state === "register" ? (
                ...
                <p>
                    ...
                    y cursor-pointer">click here</span>
                </p>
            )}
