...
const Cart = () => {
    ...
    const { products,axios,user,setCartItems, currency, cartItems, removeFromCart, getCartCount, updateCartItem, navigate, getCartAmount } = useAppContext()
  ...
  product: item._id, // change from productId to product
