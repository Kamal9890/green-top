...
const AddProduct = () => {
  ...
  return (
<div className="no-scrollbar flex-1 h-[95vh] scroll-y-auto  flex flex-col justify-between">

<form onSubmit={onSubmitHandler} className="md:p-10 p-4 space-y-5 max-w-lg pb-32">
                <div>
